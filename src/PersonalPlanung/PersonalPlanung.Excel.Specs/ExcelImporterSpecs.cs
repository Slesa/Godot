...
namespace PersonalPlanung.Excel.Specs
{
    ...
    internal class Wenn_Personen_aus_Excel_importiert_werden : ExcelImportSpecs
    {
        ...
        It sollte_externe_dienstleister_markieren = () =>
            _personen.First(x => x.Name == "USEC").Status.Name.ShouldEqual("Dienstleister");
    ...
    internal class Wenn_Veranstaltungen_aus_Excel_importiert_werden : ExcelImportSpecs
    {
        ...
        It sollte_posten_der_veranstaltung_lesen = () =>
            _veranstaltungen.First(x => x.Name == "Stadtratssitzung").Posten.Count.ShouldEqual(1);
        It sollte_rolle_der_posten_der_veranstaltung_lesen = () =>
            _veranstaltungen.First(x => x.Name == "Stadtratssitzung").Posten[0].Rolle.Name.ShouldEqual("Ordner");
        It sollte_standort_der_posten_der_veranstaltung_lesen = () =>
            _veranstaltungen.First(x => x.Name == "Stadtratssitzung").Posten[0].Standort.Name.ShouldEqual("Westeingang");
        It sollte_längeren_standort_der_posten_der_veranstaltung_lesen = () =>
            _veranstaltungen.First(x => x.Name == "Gesundheitskongress").Posten.Where(p => p.Standort.Name=="Haupteingang Ost").ShouldNotBeNull();
        It sollte_beginn_der_posten_der_veranstaltung_lesen = () =>
            _veranstaltungen.First(x => x.Name == "Stadtratssitzung").Posten[0].Beginn.ShouldEqual(new DateTime(2019, 4, 16, 12, 30, 0));
        It sollte_ende_der_posten_der_veranstaltung_lesen = () =>
