...
namespace Domain.Common.Specs
{
    ...
    [Subject(typeof(ValueObject<>))]
    internal class When_comparing_derived_value_objects_against_one_with_different_values
    {
        protected static StreetAddressWithNumber Address1;
        protected static StreetAddressWithNumber Address2;

        Establish context = () =>
        {
            Address1 = new StreetAddressWithNumber("Street", "Road Avenue 10", "Austin", "TX");
            Address2 = new StreetAddressWithNumber("Street", "StreetNumber", "Austin", "TX");
        };
    ...
    [Subject(typeof(ValueObject<>))]
    internal class When_comparing_derived_value_objects_against_one_with_equal_values
    {
        protected static StreetAddressWithNumber Address1;
        protected static StreetAddressWithNumber Address2;
        ...
        {
            Address1 = new StreetAddressWithNumber("Street", "Road Avenue 10", "Austin", "TX");
            Address2 = new StreetAddressWithNumber("Street", "Road Avenue 10", "Austin", "TX");
        };
    ...
    [Subject(typeof(ValueObject<>))]
    internal class When_comparing_value_objects_with_different_ignored_values
    {
        protected static StreetAddressWithGardens Address1;
        protected static StreetAddressWithGardens Address2;

        Establish context = () =>
        {
            Address1 = new StreetAddressWithGardens("Street", "Austin", "TX", 42);
            Address2 = new StreetAddressWithGardens("Street", "Austin", "TX", 13);
        };
    ...
    internal class StreetAddressWithGardens : StreetAddress
    {
        public StreetAddressWithGardens(string street, string city, string state, int gardens)
            : base(street, city, state)
        {
            Gardens = gardens;
        }
